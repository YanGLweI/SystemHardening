...
type Client struct {
	...
	// 关联关系
	Token           *ClientToken   `gorm:"foreignKey:ClientUUID;references:ClientUUID;onDelete:CASCADE" json:"token,omitempty"`
	CheckRecords    []SystemCheck  `gorm:"foreignKey:ClientUUID;references:ClientUUID" json:"check_records,omitempty"`
}
...
type ClientToken struct {
	ID             uint      `gorm:"primaryKey;autoIncrement" json:"id"`
	ClientUUID     string    `gorm:"uniqueIndex:idx_client_uuid;size:64" json:"client_uuid"` // 外键
